...
import { validateUserId, validateProductId, validatePagination } from "../middleware/unifiedValidation";
import {
...
router.get("/users/:userId", authorize("admin"), adminRateLimit, validateUserId, getUserAnalytics);
