...
router.get("/revenue", (0, auth_1.authorize)("admin", "seller"), (0, compression_1.staticDataCache)(300), rateLimiting_1.adminRateLimit, analyticsController_1.getRevenueAnalytics);
// Top selling products by revenue (admin and seller)
router.get("/products/top-selling", (0, auth_1.authorize)("admin", "seller"), (0, compression_1.staticDataCache)(600), rateLimiting_1.adminRateLimit, analyticsController_1.getTopSellingProducts);
